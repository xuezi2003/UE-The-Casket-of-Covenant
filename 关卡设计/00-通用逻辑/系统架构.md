...
| Comp_Character_Core | ActorComponent | Character 组件基类，抽离关卡间共性逻辑 | [Comp_Character_Core.md](核心类/Comp_Character_Core.md) |
| Comp_PC_Core | ActorComponent | PC 组件基类，提供最小共性逻辑 | [Comp_PC_Core.md](核心类/Comp_PC_Core.md) |
...
| **Comp_Character_Core** | ASC 初始化、玩家开始/完成处理、技能集管理 | BeginPlay, InitComp, HandlePlayerStart, HandlePlayerFinish, GiveAbilitySet, ClearAbilitySet |
| **Comp_PC_Core** | PC 引用缓存、为未来共性逻辑预留空间 | BeginPlay |
