...
| 激活阻止标签 | `Player.Action.Aiming`, `Player.Action.Throwing`, `Player.State.Fallen`, `Player.State.Staggered`, `Player.State.Dead`, `Player.State.Attacked` |
...
| 激活阻止标签 | `Player.Action.Throwing`, `Player.State.Fallen`, `Player.State.Staggered`, `Player.State.Dead`, `Player.State.Attacked` |
