...
详见 [场景设计](./场景搭建/场景设计.md) 与 [场景组件](./场景搭建/场景组件.md)。
...
- 详见 [道具系统.md](道具系统.md)、[瞄准投掷系统.md](GAS/瞄准投掷系统.md) 和 [BP_Item_Base.md](核心类/BP_Item_Base.md)

### 关卡资产清单

| 类别 | 资产 / 类名 | 用途 | 实现状态 | 详细文档 |
|:----:|------------|------|:--------:|----------|
| **架构** | GM_Endurance | 关卡1 GameMode | ✅ 已实现 | [GM_Endurance.md](核心类/GM_Endurance.md) |
| **架构** | GS_Endurance | 关卡1 GameState | ✅ 已实现 | [GS_Endurance.md](核心类/GS_Endurance.md) |
| **架构** | SM_Endurance | 子状态机（红绿灯） | ✅ 已实现 | [SM_Endurance.md](核心类/SM_Endurance.md) |
| **组件** | Comp_Character_Endurance | 移动检测/体力管理 | ✅ 已实现 | [Comp_Character_Endurance.md](核心类/Comp_Character_Endurance.md) |
| **组件** | Comp_PC_Endurance | QTE/投票/交互 | ✅ 已实现 | [Comp_PC_Endurance.md](核心类/Comp_PC_Endurance.md) |
| **角色** | BP_Puppet | 木偶（表现层） | ✅ 已实现 | [BP_Puppet.md](核心类/BP_Puppet.md) |
| **角色** | BP_Monitor | 监视器（逻辑层） | ✅ 已实现 | [BP_Monitor.md](核心类/BP_Monitor.md) |
| **场景** | BP_ArenaGenerator | 场地生成器 | ❌ 待实现 | [BP_ArenaGenerator.md](场景搭建/场景组件/BP_ArenaGenerator.md) |
| **场景** | BP_Section_Start | 起点封闭墙 | ❌ 待实现 | [BP_ArenaGenerator.md](场景搭建/场景组件/BP_ArenaGenerator.md#bp_section_start起点封闭墙) |
| **场景** | BP_Section_End | 终点封闭墙 | ❌ 待实现 | [BP_ArenaGenerator.md](场景搭建/场景组件/BP_ArenaGenerator.md#bp_section_end终点封闭墙) |
| **场景** | BP_Section_Wall | 单侧墙段 | ❌ 待实现 | [BP_ArenaGenerator.md](场景搭建/场景组件/BP_ArenaGenerator.md#bp_section_wall单侧墙段) |
| **场景** | BP_Section_Pillar | 单侧柱段 | ❌ 待实现 | [BP_ArenaGenerator.md](场景搭建/场景组件/BP_ArenaGenerator.md#bp_section_pillar单侧柱段) |
| **场景** | BP_VideoBoard | 终点视频黑板 | ❌ 待实现 | [BP_VideoBoard.md](场景搭建/场景组件/BP_VideoBoard.md) |
| **场景** | BP_FinishLine | 终点线触发器 | ❌ 待实现 | [BP_FinishLine.md](场景搭建/场景组件/BP_FinishLine.md) |
| **场景** | BP_BornVol | 出生体积 | ✅ 已实现 | [BP_BornVol.md](场景搭建/场景组件/BP_BornVol.md) |
| **场景** | BP_BlackboardWall | 黑板墙管理器 | ✅ 已实现 | [BP_BlackboardWall.md](场景搭建/场景组件/BP_BlackboardWall.md) |
| **场景** | BP_Camera | 壁挂监控 | ✅ 已实现 | [BP_Camera.md](场景搭建/场景组件/BP_Camera.md) |
| **场景** | BP_Obstacle | 障碍物 | ✅ 已实现 | [BP_Obstacle.md](场景搭建/场景组件/BP_Obstacle.md) |
