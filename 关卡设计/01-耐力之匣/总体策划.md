...
| **角色** | BP_Monitor | 监视器（逻辑层） | ✅ 已实现 | [BP_Monitor.md](场景/木偶与监视器/BP_Monitor.md) |
| **场景** | BP_ArenaGenerator | 场地生成器 | ❌ 待实现 | [BP_ArenaGenerator.md](场景/组件/BP_ArenaGenerator.md) |
| **场景** | BP_Section_Start | 起点封闭墙 | ❌ 待实现 | [BP_ArenaGenerator.md](场景/组件/BP_ArenaGenerator.md#bp_section_start起点封闭墙) |
| **场景** | BP_Section_End | 终点封闭墙 | ❌ 待实现 | [BP_ArenaGenerator.md](场景/组件/BP_ArenaGenerator.md#bp_section_end终点封闭墙) |
| **场景** | BP_Section_Wall | 单侧墙段 | ❌ 待实现 | [BP_ArenaGenerator.md](场景/组件/BP_ArenaGenerator.md#bp_section_wall单侧墙段) |
| **场景** | BP_Section_Pillar | 单侧柱段 | ❌ 待实现 | [BP_ArenaGenerator.md](场景/组件/BP_ArenaGenerator.md#bp_section_pillar单侧柱段) |
| **场景** | BP_VideoBoard | 终点视频黑板 | ❌ 待实现 | [BP_VideoBoard.md](场景/组件/BP_VideoBoard.md) |
| **场景** | BP_FinishLine | 终点线触发器 | ❌ 待实现 | [BP_FinishLine.md](场景/组件/BP_FinishLine.md) |
| **场景** | BP_BornVol | 出生体积 | ✅ 已实现 | [BP_BornVol.md](场景/组件/BP_BornVol.md) |
| **场景** | BP_BlackboardWall | 黑板墙管理器 | ✅ 已实现 | [BP_BlackboardWall.md](场景/组件/BP_BlackboardWall.md) |
| **场景** | BP_Camera | 壁挂监控 | ✅ 已实现 | [BP_Camera.md](场景/组件/BP_Camera.md) |
| **场景** | BP_Obstacle | 障碍物 | ✅ 已实现 | [BP_Obstacle.md](场景/组件/BP_Obstacle.md) |
