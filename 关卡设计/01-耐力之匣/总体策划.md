...
| **场景** | BP_Section_封闭墙 | 起点/终点封闭墙 | ⏳ 待测试 | [BP_Section_封闭墙.md](场景/组件/BP_Section_封闭墙.md) |
| **场景** | BP_Section_中间组件 | BP_Sectionall + BP_Section_Pillar | ⏳ 待测试 | [BP_Section_中间组件.md](场景/组件/BP_Section_中间组件.md) |
| **场景** | BP_VideoBoard | 终点视频黑板 | ⏳ 待测试 | [BP_VideoBoard.md](场景/组件/BP_VideoBoard.md) |
| **场景** | BP_StartLine | 起点线触发器 | ⏳ 待测试 | [BP_StartLine.md](场景/组件/BP_StartLine.md) |
| **场景** | BP_FinishLine | 终点线触发器 | ⏳ 待测试 | [BP_FinishLine.md](场景/组件/BP_FinishLine.md) |
...
| **场景** | 场景装饰组件 | 监控摄像头/障碍物等 | ✅ 已实现 | [场景装饰组件.md](场景/组件/场景装饰组件.md) |
