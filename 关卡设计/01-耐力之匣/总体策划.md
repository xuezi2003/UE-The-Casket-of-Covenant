...
GA_Attacked：Cooldown 检查 → Shield 抵消/扣血 (-34 HP)
    ↓
【✅ Phase 6 待验证】HP 归零 → 死亡广播 → 淘汰（离开 DS）
```
...
| **技能** | GA_Attacked / GE_Damage_Detect | 受击 / 伤害检测 | ✅ 已实现 | [GAS/伤害系统.md](GAS/伤害系统.md) |
...
| Phase 6 | 伤害判定（扣血/淘汰/死亡广播/Shield 检测减半） | ✅ (待测试) |
| Phase 6.5 | 动作互斥系统测试 | ✅ (待测试) |
