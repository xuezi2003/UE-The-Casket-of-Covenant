...
| 安全状态 | 危险状态 |
|:---------|:-----------------------|
| 静止、被遮挡、**失衡** | 行走（包括蹲行）、奔跑、跳跃、推搡、闪避、投掷、摔倒、麻痹 |
...
| Anim_Face_Idle | 面对玩家待机（循环，已旋转 180°） |
| Anim_Trun | 转身动画（BackToFace） |
| Anim_Trun_inv | 转身动画倒放（FaceToBack） |
| Anim_Detect_Face_Montage | 发现玩家反应（蒙太奇，已旋转 180°） |
